...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["═════════•°•⚠️•°•════════   ╰➥𝗧𝗬𝗣𝗘 */𝗵𝗲𝗹𝗽* 𝗦𝗵𝗼𝘄 𝗔𝗟𝗟 𝗖𝗠𝗗   •❅──────✧❅✦❅✧──────❅•  ╰➥ 𝗕𝗢𝗧 𝗔𝗗𝗠𝗜𝗡 𝗡𝗔𝗠𝗘 𝗭𝗜𝗛𝗔𝗗  ▅▄▃▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▂▃▄▅   ╰➥ 𝗕𝗢𝗧 𝗔𝗗𝗠𝗜𝗡 𝗜𝗗   https://www.facebook.com/xxn.zihad   ❛ ━━━━━━･❪ ❁ ❫ ･━━━━━━ ❜"];
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "salam ")) {
   ...
   if ((event.body.toLowerCase() == "ondrila") || (event.body.toLowerCase() == "Ohona")) {
   ...
   if ((event.body.toLowerCase() == "done") || (event.body.toLowerCase() == "হইছে")) {
     return api.sendMessage("️কিরে কি হইছে কি Done 🤔", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami zihad") || (event.body.toLowerCase() == "ami hridoy")) {
     return api.sendMessage("হ্যাঁ কলিজা ভালো আছো?", threadID);
   };
   mess = "{name}"
